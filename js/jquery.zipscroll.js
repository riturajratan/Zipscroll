/******@name    = jquery.zipscroll.js**********/

/****@purpose = to get the scroll bar as a zip ()   **************/

/****@Authorrr  = Rituraj Ratan    ******************/



/*** @depends: jQuery ,jquery.mousewheel.min.js***/
	...
	A.fn.jScrollPane = function(C) {
		...
		return this.each(function() {
			...
			if (i < 0.99) {
				...
				var oZip=A(">.jScrollPaneTrack .openZip", H);
				if (C.showArrows) {
					var g;
					var Ab;
					var S;
					...
					// by this comment code we able the top arrow click action 
